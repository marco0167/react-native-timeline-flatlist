...
export default class Timeline extends PureComponent {
  ...
  _renderEvent(rowData, rowID) {
    ...
    const columnSidePadding = rowData.columnSidePadding
      ?? this.props.columnSidePadding
      ?? 20;
    const columnSideMargin = rowData.columnSideMargin
      ?? this.props.columnSideMargin
      ?? 20;
    let opStyle = null;
    ...
    const gradientColors = rowData.gradientColors || this.props.gradientColors;
